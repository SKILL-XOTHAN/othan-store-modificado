...
const productos = {
    ...
    basicbla: {
        ...
        precio: 15000,
        img: "/othan-store-modificado/imga/basicbla.jpg",
    ...
    bossnegra: {
        ...
        precio: 15000,
        img: "/othan-store-modificado/imga/boss.jpg",
    ...
    mosne: {
        ...
        precio: 15000,
        img: "/othan-store-modificado/imga/mos ne.jpg",
    ...
    tommyne: {
        ...
        precio: 15000,
        img: "/othan-store-modificado/imga/tommy ne.jpg",
    ...
    tommybl: {
        ...
        precio: 15000,
        img: "/othan-store-modificado/imga/tomy blanca.jpg",
        descripcion: `Polera Tommy blanca confeccionada en algodón premium con corte regular fit.
                     Diseño elegante con logo minimalista, ideal para combinar con jeans o pantalones casuales.
                     Perfecta para quienes buscan comodidad y estilo con un toque de lujo.`,
        tallas: ["S", "M", "L"]
    ...
    aen: {
        ...
        precio: 15000,
        img: "/othan-store-modificado/imga/aen.jpg",
...
if (producto) {
    detalle.innerHTML = `
        ...
        <div class="info">
            ...
            <button onclick="agregarCarrito('${producto.nombre}', ${producto.precio}, ${producto.img})">Agregar al carrito</button>
